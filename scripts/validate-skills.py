...
docs/authoring.md:
  ...
  6. tests/routing/descriptions.md is in sync with the SKILL.md frontmatter
     description: fields (re-generated by scripts/extract-descriptions.py).
...
def main() -> int:
    ...
    extract = ROOT / "scripts" / "extract-descriptions.py"
    if extract.is_file():
        ...
        if result.returncode != 0:
            violations.append(
                "tests/routing/descriptions.md out of sync — "
                "run scripts/extract-descriptions.py"
            )
