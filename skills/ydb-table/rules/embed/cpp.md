...
**Source**: <https://github.com/ydb-platform/ydb/pull/52361> — `TRetryOperationSettings::CancellationToken` contract and tests; <https://github.com/ydb-platform/ydb/blob/main/ydb/public/sdk/cpp/include/ydb-cpp-sdk/client/types/request_settings.h> — absolute `Deadline`; <https://ydb.tech/docs/en/dev/timeouts> — timeout layers.
